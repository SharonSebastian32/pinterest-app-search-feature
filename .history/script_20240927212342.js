...
var arr = [
  ...
  },
  {
    ...
    },
    {
        ...
        image:'https://images.unsplash.com/photo-1628445373211-216165d598bc?q=80&w=1906&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  }
  {
    name: "Apple Juice",
    image:
...
function showTheCards() {
  ...
  arr.forEach(function (obj) {
    flutter += ` <div class='box'>
    <img src="${obj.image}" class='cursor-pointer'>
    </img>
    <div class='captions'>${obj.name}</div>
    </div>`;
  });
  document.querySelector(".container").innerHTML = flutter;
}

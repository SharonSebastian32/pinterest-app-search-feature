...
var arr = [
  {
    name: "Petals of roses",
    image: "https://images.unsplash.com/photo-1579591040020-5704f25f2473?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  // ... (other image objects)
];
...
function showTheCards(images) {
  ...
  var clutter = images.map(obj => `
    <div class='box'>
      <img src="${escapeHTML(obj.image)}" class='cursor-pointer' alt="${escapeHTML(obj.name)}">
